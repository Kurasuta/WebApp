  ...
  render() {
    return (
      <div>
        ...
        <p>Currently you can put a SHA256 hash of a sample into the text box and - in case we already
          processed that sample - get back some information on the corresponding PE file together with a list of
          sections. Clicking on the SHA256 hash of a section shows a list of samples also containing that section.</p>
        <p>There are, of course, many ideas around this project: More samples, machine learning, more edges
